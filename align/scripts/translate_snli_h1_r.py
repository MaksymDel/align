...
f = open("data/snli/snli_1.0/snli_1.0_train.h1.rev.jsonl")                                                                                                                                                                                          

f_en = open('data/snli/train/snli.train.h1.rev.en.jsonl', mode='wt', encoding='utf-8')
f_fr = open('data/snli/train/snli.train.h1.rev.fr.jsonl', mode='wt', encoding='utf-8')
