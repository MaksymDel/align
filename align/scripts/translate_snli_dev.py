...
f = open("data/snli/snli_1.0/snli_1.0_dev.jsonl")                                                                                                                                                                                          

f_en = open('data/snli/train/snli.dev.en.jsonl', mode='wt', encoding='utf-8')
f_fr = open('data/snli/train/snli.dev.fr.jsonl', mode='wt', encoding='utf-8')
