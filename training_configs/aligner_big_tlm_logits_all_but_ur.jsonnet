...
local ALIGN_TASKS = ['ar', 'bg', 'de', 'el', 'en', 'es', 'fr', 'hi', 'ru', 'sw', 'th', 'tr', 'vi', 'zh'];
...
local ALIGN_LANG_PAIRS= "en-en ar-en bg-en de-en el-en en-es en-fr en-hi en-ru en-sw en-th en-tr en-vi en-zh";
#local ALIGN_LANG_PAIRS = "en-fr";
local ALIGN_TASKS_2PIRNT = ['en,, fr', 'de', 'sw', "ur"];

local learners_ser_dir = "experiments/pseudo_tlm_no_ur/";
