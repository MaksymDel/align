...
local XNLI_TASKS_NOUR = ['nli-ar', 'nli-bg', 'nli-de', 'nli-el', 'nli-en', 'nli-es', 'nli-fr', 'nli-hi', 'nli-ru', 'nli-sw', 'nli-th', 'nli-tr', 'nli-vi', 'nli-zh'];

local learners_ser_dir = "experiments/aligner_tlm_logits_no_ur/";
...

{
    ...
    "train_data_path": "data/translate_train/xnli.train.no_ur.jsonl",
    ...
    "model": {
        ...
        "training_tasks": XNLI_TASKS_NOUR,
        "validation_tasks": XNLI_TASKS,
    
        "input_embedder": {
            "_pretrained": {
                "archive_file": student_archive,
                "module_path": "_student_xlm.token_embedder_bert",
                "freeze": false
            },
        },
